...
public class JmsMessageInOnlyExchangePatternTest extends CamelTestSupport {
    ...
    @Test
    public void measureJmsInOnlyExecution() throws Exception {
        ...
        System.out.println("measureJmsInOnlyExecution duration: " + watch.taken() + "ms");
    }
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("direct:start")
                    .inOnly("activemq:queue:INONLY");

                from("activemq:queue:INONLY?concurrentConsumers=5")
