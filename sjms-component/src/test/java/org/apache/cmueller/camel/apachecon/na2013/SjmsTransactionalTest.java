...
public class SjmsTransactionalTest extends CamelTestSupport {
    ...
    @Test
    public void measureSjmsTransactionalExecution() throws Exception {
        ...
        System.out.println("measureSjmsTransactionalExecution duration: " + watch.stop() + "ms");
    }
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                ...
                from("sjms:queue:INONLY?transacted=true")
                    .to("mock:end");
            }
        };
    }
