...
public class SjmsTransactionalBatchConsumerTest extends CamelTestSupport {
    ...
    @Test
    public void measureSjmsTransactionalBatchConsumerExecution() throws Exception {
        ...
        System.out.println("measureSjmsTransactionalBatchConsumerExecution duration: " + watch.stop() + "ms");
    }
