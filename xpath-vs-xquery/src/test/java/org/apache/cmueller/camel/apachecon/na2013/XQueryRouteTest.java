...
public class XQueryRouteTest extends CamelSpringTestSupport {
	...
	public void measureXQueryExecution() throws Exception {
		...
		watch.stop();
		System.out.println("measureXQueryExecution duration: " + watch.taken() + "ms");
	...
	protected AbstractApplicationContext createApplicationContext() {
		return new ClassPathXmlApplicationContext("META-INF/spring/bundle-context-xquery.xml");
	}
}
