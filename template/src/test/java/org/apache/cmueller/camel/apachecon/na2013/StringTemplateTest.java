...
public class StringTemplateTest extends CamelTestSupport {
    ...
    @Test
    public void measureStringTemplateExecution() throws Exception {
        ...
        System.out.println("measureStringTemplateExecution duration: " + watch.stop() + "ms");
    }
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("direct:start")
                    .to("string-template:template.txt")
                    .to("mock:end");
            }
        };
    }
