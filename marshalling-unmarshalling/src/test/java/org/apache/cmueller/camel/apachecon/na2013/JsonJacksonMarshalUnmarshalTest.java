...
public class JsonJacksonMarshalUnmarshalTest extends CamelTestSupport {

    private int repeatCounter = 10000;

    @Test
    public void measureJsonJacksonMarshalUnmarshalExecution() throws Exception {
        ...
        System.out.println("measureJsonJacksonMarshalUnmarshal duration: " + watch.stop() + "ms");
    }
