...
public class JaxbMarshalUnmarshalTest extends CamelTestSupport {

    private int repeatCounter = 10000;

    @Test
    public void measureJaxbMarshalUnmarshalExecution() throws Exception {
        ...
        System.out.println("measureJaxbMarshalUnmarshal duration: " + watch.stop() + "ms");
    }
