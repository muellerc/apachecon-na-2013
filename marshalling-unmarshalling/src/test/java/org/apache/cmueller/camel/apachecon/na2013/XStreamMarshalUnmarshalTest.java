...
public class XStreamMarshalUnmarshalTest extends CamelTestSupport {

    private int repeatCounter = 10000;

    @Test
    public void measureXStreamMarshalUnmarshalExecution() throws Exception {
        ...
        System.out.println("measureXStreamMarshalUnmarshal duration: " + watch.stop() + "ms");
    }
