...
public class SerializationMarshalUnmarshalTest extends CamelTestSupport {

    private int repeatCounter = 10000;

    @Test
    public void measureSerializationMarshalUnmarshalExecution() throws Exception {
        ...
        System.out.println("measureSerializationMarshalUnmarshal duration: " + watch.stop() + "ms");
    }
    ...
    private void warmUp(BuyStocks payload) throws Exception {
        getMockEndpoint("mock:end").expectedMessageCount(repeatCounter);
        getMockEndpoint("mock:end").setRetainFirst(0);
        getMockEndpoint("mock:end").setRetainLast(0);
