...
public class JsonGsonMarshalUnmarshalTest extends CamelTestSupport {

    private int repeatCounter = 10000;

    @Test
    public void measureJsonGsonMarshalUnmarshalExecution() throws Exception {
        ...
        System.out.println("measureJsonGsonMarshalUnmarshal duration: " + watch.stop() + "ms");
    }
